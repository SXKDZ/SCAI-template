...
%%   \alice{comment}       — plain comment
%%   \alice[r]{text}       — strikethrough (suggest removal)
%%   \alice[h]{text}       — highlight (draw attention)
\alice{This paragraph needs more detail on the experimental setup.}
\alice[r]{This sentence is redundant and should be removed.}
\alice[h]{This claim needs a citation.}
